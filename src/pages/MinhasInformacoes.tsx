...
const MinhasInformacoes = () => {
  const { loading } = useProfileData(); // Mantemos o loading para a tela de espera
  ...
  // Adicionando Dados Pessoais ao menu
  const menuItems = [
    { title: "Dados Pessoais", path: "/cadastro/dados-pessoais" },
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-white dark:bg-gray-900 p-4">
      ...
      <div className="w-full max-w-sm md:max-w-md flex flex-col items-center">
        ...
        {/* Menu de Navegação (incluindo Dados Pessoais) */}
